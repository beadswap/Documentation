...
> The transaction cannot succeed due to error: BeadRouter: INSUFFICIENT\_OUTPUT\_AMOUNT. This is probably an issue with one of the tokens you are swapping.
...
However, there's also the chance that you're trying to trade a scam token which cannot be sold. In this case, BeadSwap isn't able to block a token or return funds.
{% endtab %}
{% endtabs %}

### **INSUFFICIENT\_A\_AMOUNT or INSUFFICIENT\_B\_AMOUNT**

> Fail with error 'BeadRouter: INSUFFICIENT\_A\_AMOUNT'  
> or  
> Fail with error 'BeadRouter: INSUFFICIENT\_B\_AMOUNT'
...
### BeadBeadRouter: EXPIRED

> The transaction cannot succeed due to error: BeadRouter: EXPIRED. This is probably an issue with one of the tokens you are swapping.
...
> The transaction cannot succeed due to error: Bead: K. This is probably an issue with one of the tokens you are swapping.
